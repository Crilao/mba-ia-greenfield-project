...
import { CreateVideos1790198954609 } from './migrations/1790198954609-CreateVideos';
...
describe('Database migrations (integration)', () => {
  ...
  beforeAll(async () => {
    ...
    await Promise.all([
      ...
      dataSource.query(`DROP TYPE IF EXISTS "public"."video_status" CASCADE`),
      dataSource.query(
